...
<div class="w-full">
    <div class="flex mb-7">
        <a href="/tambah_deskripsi" class="flex gap-1 bg-slate-500 items-center text-white rounded-1 font-montserrat font-medium py-2 px-4">
            Tambah Deskripsi
        </a>
    </div>
    ...
    <table class="w-full text-left">
        <thead class="text-sm text-white bg-slate-500">
            <tr>
                ...
                <th scope="col" class="px-6 py-3 mr-19 font-bold">
                    Deskripsi
                </th>
        ...
        <tbody class="divide-y divide-gray-200">
            <?php foreach ($deskripsi as $index => $d) : ?>
                <tr class="<?= $index % 2 === 0 ? 'bg-white' : 'bg-slate-500/10' ?> border-b mr-6">
                    <th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap truncate max-w-[100px]">
                        <img src="/img/<?= $d['foto']; ?>" alt="" class="w-1/4">
                    </th>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-center">
                            <div class="flex justify-center">
                                <a class="mr-2" href="/update_deskripsi/<?= $d['id_deskripsi']; ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-blue-600">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                    </svg>
                                </a>
                                <a class="mr-2" href="/hapus_deskripsi/<?= $d['id_deskripsi']; ?>">
