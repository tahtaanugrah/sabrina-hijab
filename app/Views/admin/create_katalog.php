...
<form action="/tambah_katalog_save" method="post" class="w-full" enctype="multipart/form-data">
      ...
      <input type="text" name="namakatalog" id="namakatalog" value="<?= old('namakatalog') ?>" class="bg-gray-50 mb-3 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">      
