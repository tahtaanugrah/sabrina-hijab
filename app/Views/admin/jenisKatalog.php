...
<div class="w-full">
    <div class="flex mb-7">
        <a href="/tambah_jenis" class="flex gap-1 bg-slate-500 items-center text-white rounded-1 font-montserrat font-medium py-2 px-4">
            Tambah Jenis Katalog
        </a>
    </div>
            ...
            <?php foreach ($jenis as $index => $j) : ?>
                <tr class="<?= $index % 2 === 0 ? 'bg-white' : 'bg-slate-500/10' ?> border-b mr-6">
                    <th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap truncate max-w-[100px]">
                        <img src="/img/<?= $j['foto']; ?>" alt="" class="w-1/4">
                    </th>
